...
import (
	...
	"github.com/cloudflare/terraform-provider-cloudflare/cmd/migrate-v2/handlers"
	interfaces2 "github.com/cloudflare/terraform-provider-cloudflare/cmd/migrate-v2/interfaces"
...
func (m *MockResourceTransformer) TransformConfig(block *hclwrite.Block) (*interfaces2.TransformResult, error) {
	return nil, nil
}
...
func TestPreprocessHandler(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Create context
			ctx := &interfaces2.TransformContext{
